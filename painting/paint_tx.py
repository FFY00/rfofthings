...
# Title: Paint Tx
# Generated: Wed Mar  7 17:02:10 2018
##################################################
...
class paint_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.paint_paint_bc_0 = paint.paint_bc(200, 8, paint.EQUALIZATION_OFF, paint.INTERNAL, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/anubis/git/rfofthings/painting/troll-rev.bin', True)
